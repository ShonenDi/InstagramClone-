...
public class SocialMediaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        customTabAdapter = new CustomTabAdapter(getSupportFragmentManager());
                ...
                dialog.setMessage("Loading");
                 ...
                 parseObject.saveInBackground(new SaveCallback() {
                     ...
                     public void done(ParseException e) {
                         if(e ==null){
                             FancyToast.makeText(SocialMediaActivity.this, "Done!", Toast.LENGTH_SHORT, FancyToast.SUCCESS, false).show();
                             dialog.dismiss();
                         } else {
                             FancyToast.makeText(SocialMediaActivity.this, "You must select the image", Toast.LENGTH_SHORT, FancyToast.ERROR, false).show();
                             dialog.dismiss();
                         }
                     }
                 });
